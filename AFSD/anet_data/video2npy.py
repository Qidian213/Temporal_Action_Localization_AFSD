...
parser.add_argument('--video_dir', type=str, default='/data/Dataset/MMAction/Task2_Cross_Modal_Untrimmed_Action_Temporal_Localization/untrimmed/video_112_2304')
parser.add_argument('--output_dir', type=str, default='/data/Dataset/MMAction/Task2_Cross_Modal_Untrimmed_Action_Temporal_Localization/untrimmed/video_112_2304_npy')
