...
# origin_video_info_path = '/data/Dataset/MMAction/Task2_Cross_Modal_Untrimmed_Action_Temporal_Localization/untrimmed/trainval_ASFD.json'
# new_video_info_path    = '/data/Dataset/MMAction/Task2_Cross_Modal_Untrimmed_Action_Temporal_Localization/untrimmed/trainval_112_2304.json'
# video_dir              = '/data/Dataset/MMAction/Task2_Cross_Modal_Untrimmed_Action_Temporal_Localization/untrimmed/video_112_2304'
...
# for video_name in video_list:
    ...
    # for anno in json_data[video_name]['annotations']:
        ...
        # label    = anno['label']
        # label_id = anno['label'] # class_to_id[label]
        # annotations.append({
...
origin_video_info_path = '/data/Dataset/MMAction/Task2_Cross_Modal_Untrimmed_Action_Temporal_Localization/test/test_ASFD.json'
new_video_info_path    = '/data/Dataset/MMAction/Task2_Cross_Modal_Untrimmed_Action_Temporal_Localization/test/test_ASFD_Submit.json'
