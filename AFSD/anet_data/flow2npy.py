...
parser.add_argument('--video_info_path', type=str, default='/data/Dataset/MMAction/Task2_Cross_Modal_Untrimmed_Action_Temporal_Localization/test/test_ASFD_Submit.json')
parser.add_argument('--flow_frame_path', type=str, default='/data/Dataset/MMAction/Task2_Cross_Modal_Untrimmed_Action_Temporal_Localization/test/video_112_2304_flow')
parser.add_argument('--flow_npy_path', type=str, default='/data/Dataset/MMAction/Task2_Cross_Modal_Untrimmed_Action_Temporal_Localization/test/video_112_2304_flow_npy')
parser.add_argument('--max_frame_num', type=int, default=2304)
